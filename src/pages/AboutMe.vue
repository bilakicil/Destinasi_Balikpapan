...
<template>
  <h2
    class="text-2xl sm:text-3xl lg:text-3xl font-heading font-bold text-gray-800 mb-6 text-center pt-20 sm:pt-24 px-4 sm:px-0"
  >
    Tentang <span class="text-primary">Saya</span>
  </h2>
